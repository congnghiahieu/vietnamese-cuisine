...
const MyFeed = () => {
    ...
    const getpostList = async () => {
        try {
            ...
            const fetchedPostList: Post[] = querySnapshot.docs.map((doc) => ({
                postId: doc.id,
                ...doc.data(),
            } as Post));
            ...
            console.error(
                "Error fetching post list data from FIRESTORE:",
                error
            );
        }
    };
...
const WannaPost = () => {
    ...
    return (
        <StyledPressable
            ...
            onPress={() =>
                router.push("/(sidebar)/(protected)/community/publish")
            }
        >
        ...
        <View style={styles.card}>
            ...
            <View style={styles.footer}>
                ...
                <StyledPressable
                    style={styles.button}
                    onPress={() =>
                        router.push("/(sidebar)/(protected)/community/comment")
                    }
                >
                    <CommentIcon />
